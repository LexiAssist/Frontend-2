        ...
        <div className="w-full max-w-md bg-white border border-slate-100 shadow-[0_15px_40px_rgba(0,0,0,0.02)] rounded-3xl p-6 sm:p-10 space-y-6 sm:space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {errors.password ? (
                <p className="text-xs font-semibold text-red-600 mt-1">{errors.password.message}</p>
              ) : (
            ...
            <button
              ...
              className="w-full h-12 mt-2 bg-gradient-to-r from-[#3D7A52] to-[#2D5A3D] hover:from-[#3D7A52] hover:to-[#22452E] text-white font-bold rounded-xl shadow-md shadow-emerald-800/10 active:scale-[0.985] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isSubmitting ? (
