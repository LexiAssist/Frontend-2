  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] pb-12">
      ...
      {currentStep === 'upload' && (
        ...
        >
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-slate-50/50 to-[var(--primary-50)]/20 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.015)]">
            <HexPattern />
